// base code Taken from https://github.com/fainapahanko/Conway-s-Game-Of-Life/blob/master/GameOfLife.js
    ...
    */
    ...
    constructor() {
        ...
        this.arrayRandomize = () => {
            ...
            for (let i = 0; i < this.cells_in_rows; i++) {
                for (let j = 0; j < this.cells_in_column; j++) {
                    this.active_array[i * (this.cells_in_column)] = (Math.random() > 0.5) ? 1 : 0;
                }
            }
